...
function App() {
  ...
  const analyzeImage = async (file: File) => {
    setIsLoading(true);
    setAnalysisResult('');
    const imageForPreview = URL.createObjectURL(file);
    setImageSrc(imageForPreview);
    ...
    try {
      ...
      **Analysis Rules:**
      ...
      4.  **Formatting:** Format your entire response using simple paragraphs. Use bold text for titles (e.g., **Analysis:**, **Health Assessment:**) instead of using Markdown headings (#) or bulleted lists (*).
      5.  **Language:** Respond in Polish.`;
      ...
      <main>
        ...
        <div className="results-container">
          ...
          <div className="analysis-output">
            ...
            {!isLoading && analysisResult && <ReactMarkdown>{analysisResult}</ReactMarkdown>}
              ...
              {history
                ...
                <div key={item.id} className="history-item">
                  ...
                  <div className="history-item-content">
                    ...
                    <ReactMarkdown>{item.analysisResult.substring(0, 100)}...</ReactMarkdown>
                  </div>
                </div>
              ))}
            </div>
